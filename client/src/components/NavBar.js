  ...
  return (
    <nav className="navbar navbar-expand-lg user-navbar-custom sticky-top">
      <div className="container">
        <a className="navbar-brand user-navbar-brand" href="/">
        ...
        <div className={`${isNavCollapsed ? 'collapse' : ''} navbar-collapse user-navbar-collapse`} id="navbarContent">
          ...
          <div className="user-navbar-auth d-flex align-items-center">
            <button className="btn btn-outline-light user-navbar-btn-outline me-2">Sign In</button>
            <button className="btn user-navbar-btn-accent">Sign Up</button>
            <div className="user-navbar-profile ms-3">
              <div className="user-navbar-profile-icon">
